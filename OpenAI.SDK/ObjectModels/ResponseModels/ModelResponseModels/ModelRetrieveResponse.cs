...
{
    public class ModelRetrieveResponse : ModelResponse
    ...
    public class ModelResponse : BaseResponse
    {
        ...
        [JsonPropertyName("permission")] public List<Permission> Permissions { get; set; } = new List<Permission>();
    ...
    public class Permission : BaseResponse
    {
        [JsonPropertyName("id")] public string Id { get; set; }
